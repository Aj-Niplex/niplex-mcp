...
This folder is the internal manual for the whole system — not just this one repo, but how Niplex-MCP, Neural-MCP, Horizon, and HidenCloud all fit together.

| File | What's in it |
|---|---|
| [ARCHITECTURE.md](./ARCHITECTURE.md) | The full picture — every piece, what it does, how they talk to each other |
